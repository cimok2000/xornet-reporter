...
unzip /etc/xornet/xornet-reporter-linux-v0.0.21.zip ./
chmod +x /etc/xornet/xornet-reporter-linux-v0.0.21.bin
echo "Xornet reporter downloaded!"

# Download service
sudo wget "https://cdn.discordapp.com/attachments/806300597338767450/856105546789027920/xornet.service" -P /etc/systemd/system
